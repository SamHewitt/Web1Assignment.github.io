...
const xhr = new XMLHttpRequest();
    ...
    xhr.onload = () => {
        if (xhr.status === 200){
            ...
            list.innerHTML = list.innerHTML + `<div class="item-listing"><br>${p.id}<br><img src="${p.img}" height="200" width = "200"></img> <br>${p.pantsName}<br> ${p.pantsType}<br> ${p.pantsSummary}</div></br>`;
            })
        }
