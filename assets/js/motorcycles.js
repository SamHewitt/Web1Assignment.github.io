...
const xhr = new XMLHttpRequest();
    ...
    xhr.onload = () => {
        if (xhr.status === 200){
            ...
            list.innerHTML = list.innerHTML + `<div class="item-listing"><br>${p.id}<br><img src="${p.img}" height="200" width = "250"></img> <br>${p.bikeName}<br> ${p.bikeType}<br> ${p.bikeSummary}</div><br>`;
            })
        }
